...
class WorkersTest < ApplicationSystemTestCase
  ...
  test "creating a Worker" do
    ...
    fill_in "Boring", with: @worker.boring
    fill_in "Building", with: @worker.building_id
    fill_in "Edu", with: @worker.edu
    fill_in "Lastname", with: @worker.lastname
    fill_in "Lvl", with: @worker.lvl
    fill_in "Name", with: @worker.name
    fill_in "Offer", with: @worker.offer
