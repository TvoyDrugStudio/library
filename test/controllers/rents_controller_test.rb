...
class RentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rent" do
    assert_difference('Rent.count') do
      post rents_url, params: { rent: { book_id: @rent.book_id, give: @rent.give, giveback: @rent.giveback, user_id: @rent.user_id } }
    end
  ...
  test "should update rent" do
    patch rent_url(@rent), params: { rent: { book_id: @rent.book_id, give: @rent.give, giveback: @rent.giveback, user_id: @rent.user_id } }
